...
class test_caesar(unittest.TestCase):
    ...
    def test_tenkey_rshift(self):
        ...
        self.assertEqual(tenkey_lshift(tenkey_rshift(teststring,key),key), teststring)
        self.assertEqual(tenkey_lshift(tenkey_rshift(teststring,key, False),key,False), teststring)
